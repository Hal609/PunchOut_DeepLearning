...
class PunchOutModel(SDPModel):
    ...
    def custom_grayscale(self, frame, red_weight, green_weight, blue_weight):
    ...
    def process_frame_buffer(self):
        ...
        # Define the new size (e.g., 84x84 pixels as commonly used in DQN)
        ...
        gray_image = self.custom_grayscale(resized, 0.1, 0.9, 0.0)

        # # Define a convolution kernel (e.g., Sobel operator for edge detection)
        ...
        cv2.imwrite('output.bmp', gray_image)
